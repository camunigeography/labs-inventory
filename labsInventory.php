	...
	public function databaseStructure ()
	{
		return "
			...
			CREATE TABLE `equipment` (
			  ...
			  `equipmentTypeId` int NOT NULL COMMENT 'Equipment type',
			  ...
			  `locationId` int DEFAULT NULL COMMENT 'Location',
			  ...
			  `orderNumber` varchar(255) DEFAULT NULL COMMENT 'Order number',
			  `supplier` varchar(255) DEFAULT NULL COMMENT 'Supplier',
			  `photograph` varchar(255) DEFAULT NULL COMMENT 'Photograph',
			  `internalNotes` text COMMENT 'Internal notes',
			  `urlTechniques` varchar(255) DEFAULT NULL COMMENT 'Link to relevant techniques and protocols page',
			  `urlHealthAndSafetyInfo` varchar(255) DEFAULT NULL COMMENT 'Link to relevant health and safety page',
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Equipment';
			
			CREATE TABLE `equipmentGroups` (
			  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Unique key',
			  `group` varchar(255) NOT NULL COMMENT 'Group',
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Equipment groups';
			...
			CREATE TABLE `equipmentTypes` (
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Equipment type';
			
			CREATE TABLE `locations` (
			  `id` int NOT NULL AUTO_INCREMENT,
			  `location` varchar(255) NOT NULL,
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Locations';
			...
			CREATE TABLE `shoppingcart` (
			  ...
			  `vat` enum('Y','N') DEFAULT NULL COMMENT 'Price includes VAT?',
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Shopping cart session information (do not edit)';
			...
			CREATE TABLE `shoppingcartOrders` (
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Shopping cart orders';
			...
			CREATE TABLE `sundries` (
			  ...
			  PRIMARY KEY (`id`)
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Sundries';
		";
	}
